...
/**
	...
	\param	hPrevInstance	niby uchwyt do poprzedniej instancji, w praktyce NULL
...
int WINAPI WinMain(HINSTANCE hInstance , HINSTANCE hPrevInstance , LPSTR lpCmdLine, int nCmdShow)
{
	...
	if(eApp == NULL)	// brak mozliwosci zrzutowania na ExampleApplication*
	{
	...
	{
		std::cerr << "Przechwycono wyjatek " << e.type() << ": " << e.message() << std::endl;	// wypisujemy informacjê o b³êdzie
